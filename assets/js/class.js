...
/*
  ...
  животные имеют вид и кличку

  животные имеют методы имитирующие еду и речь

  создайте 2-3 классов наследующихся от животных (змея, кот итд)
  у них будут свои версии еду и речь

  и создайте обьект дрессировщика
  в нем есть метод покормить, потренировать речь. 
  Этот метод принимает животное
